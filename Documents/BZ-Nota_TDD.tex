...
\hline
1.3 & \date{02.03.2026} & Barkın Zorlu & Update to v0.7.0 - Kitty Keyboard Protocol and CTRL formatting shortcuts \\
\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Handles VT100 and Kitty Keyboard Protocol escape sequences
...
\begin{itemize}
    \item Reading keyboard input from terminal using Kitty Keyboard Protocol
...
// Formatting (Ctrl + key in FANCY/DOCUMENT modes)
Ctrl+B         => Toggle bold
