...
\hline
1.0 & \today & BZ-Interactive & Complete TDD Creation \\
\hline
\end{tabular}
\end{table}
...
\hline
\textbf{UI Renderer} & Renders the user interface using FTXUI framework \\
\hline
...
\hline
\textbf{Format Manager} & Handles text formatting and syntax highlighting \\
\hline
...
\hline
ui\_renderer.hpp/cpp & FTXUI rendering engine; parses markdown formatting \\
\hline
