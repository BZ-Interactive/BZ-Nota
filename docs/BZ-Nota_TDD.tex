...
\begin{itemize}
	...
	\item Theme preference is not persisted - always starts in dark mode on launch
	\item Theme preference will be stored in a config file for automatic switching on startup (future enhancement)
\end{itemize}
...
\medskip
\textit{Note: In the current implementation, F7 toggles between BASIC and FANCY modes only. CODE and DOCUMENT modes will be fully implemented in a future release.}
