...
# Remove Binary and Desktop Shortcut
rm -f "$INSTALL_PREFIX/bin/bznota"
rm -f "$INSTALL_PREFIX/share/applications/bznota.desktop"

# Remove Icons (Paths corrected to match square ${size}x${size} dimensions)
...
# Remove Data and License Directories
rm -rf "$INSTALL_PREFIX/share/bznota"
rm -rf "$INSTALL_PREFIX/share/licenses/bznota"

# Safely clean up the app directories ONLY if they are empty
